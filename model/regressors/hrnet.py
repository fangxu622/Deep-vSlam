...
POSE_HIGH_RESOLUTION_NET.STAGE1.FUSE_METHOD = 'SUM'
...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,  **kwargs):
        ...
        self.stage1_cfg = POSE_HIGH_RESOLUTION_NET.STAGE1
        ...
        self.final_layer =nn.Conv2d(1024, 96, 3, 2, 0)
        self.classifier = nn.Linear(2048, 1000)

    def _make_head(self, pre_stage_channels):# 四个阶段的输入通道数
        head_block = Bottleneck
        head_channels = [32, 64, 128, 256] # 四个阶段的头通道数
...
if __name__ == "__main__":
    ...
    print(model)
    test_data = torch.rand(8, 3, 224, 224)
    test_outputs = model(test_data)  # 3 feature maps
